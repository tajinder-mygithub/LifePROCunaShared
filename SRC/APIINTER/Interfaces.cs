...
namespace PDMA.LifePro 
{
    ...
    public interface IBalInqu {
        ...
        // Draft:  Create sub-calls to save time and allow RC/Error Message to be per function.  
        // New users should use these three.  RunInquiry will be left unchanged.  
        [OperationContract(IsInitiating = false, IsTerminating = false)]
        BalanceInquiryQuoteResponse RunQuoteOnly(BalanceInquiryRequest inProps);


        [OperationContract(IsInitiating = false, IsTerminating = false)]
        BalanceInquiryGuaranteedWithdrawalResponse GetGuaranteedWithdrawalValues(BalanceInquiryRequest inProps);


        [OperationContract(IsInitiating = false, IsTerminating = false)]
        BalanceInquiryGuaranteedRetirementResponse GetGuaranteedRetirementValues(BalanceInquiryRequest inProps); 
