...
*  -----------------------------------------------------------------------
*  951027-008-01  DJO    10/28/95    Program Creation
*  980313-002-01  RDE    04/29/98    Port to UNIX
*  990119-004-01  RDE    03/16/99    convert to a dll, return a success code
*    
*
***************************************************************************
***************************************************************************
*  #
*  # Makefile for program: clpparch
*  # Cut and paste into clpparch.mak and type nmake /f clpparch.mak
*  #
*  
*  .c.obj:
*              cl  -c -W3 -Gs -AL -Od -G2 $*.c
*  #            cl  /Zi -c -W4 -Gs -AL -Od -G2 $*.c
*  
*  clpparch.exe:  clpparch.obj
*  # link   /CO clpparch, clpparch;
*   link   /E clpparch, clpparch;
*  
*  clpparch.obj: clpparch.c 
*  
***************************************************************************/
#include <stdio.h>
#include <stdlib.h>
...
int _loadds _export
#endif
 clpparch(char *function, char *pgFileName, char *archFileName)
